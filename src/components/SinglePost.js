...
export default function SinglePost(props) {
  ...
  return (
    <main className="min-w-screen min-h-screen flex flex-col justify-center items-center bg-green-50 py-20">
      <div className="w-3/4 lg:w-2/3 min-h-[55dvh] lg:flex justify-between items-center px-5 lg:py-10 bg-white rounded-md shadow-lg">
        <a href="https://www.google.com" target="_blank" className=" h-fit ">
          <img
            src={currentProject.image}
            className="w-[900px] h-fit px-3 hover:contrast-50 before:content-[&gt]"
          />
        </a>
        <div className="mt-5">
