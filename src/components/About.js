...
export default function About() {
  return (
    <main className="flex flex-col justify-center content-evenly flex-wrap min-w-screen min-h-screen py-20 lg:py-32">
      <div className="lg:flex justify-around items-center w-[90%] mx-auto">
      ...
      <div className="lg:flex justify-around items-center flex-wrap w-[90%] mt-7">
        <div className="w-[90%] lg:w-1/3 mx-auto">
        ...
        <div className="lg:w-1/3 gap-3">
          <p className="text-lg font-para py-3">
            {" "}
          ...
          <form className="flex flex-col gap-4 text-center">
            <input
              ...
              className="border-2 border-blue-950 rounded-lg w-full py-2 px-2"
            />
            <input
              type="email"
            ...
            <textarea
              ...
              className="border-2 border-blue-950 rounded-lg w-full py-3 px-2"
            />
